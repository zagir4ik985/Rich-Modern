...
public class BackgroundRenderer {
    ...
    public void render(DrawContext context, float bgX, float bgY, float alphaMultiplier) {
        ...
        Render2D.gradientRect(bgX, bgY, 520, 325, gradientColors, 15);
    }
    ...
    public void renderCategoryPanel(float bgX, float bgY, float bgHeight, float alphaMultiplier) {
        ...
        Render2D.outline(bgX + 12.5f, bgY + 295.5f, 70, 17, 0.5f, new Color(55, 55, 55, outlineAlpha).getRGB(), 5);

        Fonts.GUI_ICONS.draw("X", bgX + 21.15f, bgY + 292.5f, 19, new Color(58, 58, 58, outlineAlpha).getRGB());
        Fonts.GUI_ICONS.draw("Y", bgX + 40f, bgY + 292f, 20, new Color(58, 58, 58, outlineAlpha).getRGB());
        Fonts.GUI_ICONS.draw("Z", bgX + 60f, bgY + 292f, 20, new Color(58, 58, 58, outlineAlpha).getRGB());

        Render2D.blur(bgX + 12.5f, bgY + 295.5f, 70, 17, 4, 5, new Color(25, 25, 25, blurAlpha).getRGB());
        ...
        float centerY = bgY + 295.5f + (17 - textHeight) / 2f;
